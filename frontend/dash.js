...
async function handleEdit(event) {
    ...
    const productId = event.target.dataset.id;
      ...
      row.innerHTML = `
        ...
        <td><input type="text" id="editSubCategory" value="${product.SubCategory}" /></td>
  ...
  async function handleSave(event, productId, row) {
    ...
    const newSubCategory = document.getElementById("editSubCategory").value;
            ...
            data.Data.forEach(order => {
                ...
                const productDetails = order.Items.map(item => `
                    <div>
                        ...
                        Category: $${item.CategoryAtOrder}<br>
                        SubCategory: $${item.SubCategoryAtOrder}<br>
